        ...
        <div class="col-md-6">
            <form method="POST" action="./UpdateController">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="job_title" name="job_title" placeholder="Enter job title" value="${salary.job_title}">
                </div>
                
                <div class="mb-3">
                    <label for="salary" class="form-label">Enter Salary:</label>
                    <input type="text" class="form-control" id="salary" name="salary" placeholder="Enter salary" value="${salary.salary}">
                </div>
